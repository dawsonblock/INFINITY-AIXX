...
# Ensure vendored deps (e.g., vendor/mamba_ssm) are importable without pip installs.
_VENDOR_PATH = _os.path.abspath(_os.path.join(_os.path.dirname(__file__), "..", "..", "vendor"))
